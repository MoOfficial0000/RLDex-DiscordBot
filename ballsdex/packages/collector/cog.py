...
uncountablespecials = ("First natural shiny","Kaiser Fusion Fest","Kaiser Demolition Fest","Champion Edition Goku","Champion Edition Vegeta","Ruby","Boss","Staff","Emerald","Shiny","Mythical","Relicborne","Collector","Diamond","Xeno Goku Black","Champion Edition Quitela","Ultra Gogito","Goku Day","Gold","Titanium White","Black","Cobalt","Crimson","Forest Green","Saffron","Sky Blue","Pink","Purple","Lime","Orange","Grey","Burnt Sienna")
